...
(function() {
  $(function() {
    var cw, delay, fightScore;
    $('#gallery-show').imagesLoaded(function() {
      return $('#gallery-show').masonry({
        itemSelector: '.well',
        isFitWidth: true
      });
    });
    ...
    fightScore = function() {
      ...
      if (kentscore > parseFloat(eateryscore)) {
        ...
        return $('.eatery-well').removeClass("animated bounceInLeft").addClass("loser");
      } else if (eateryscore > parseFloat(kentscore)) {
        $('.kent-well').removeClass("animated bounceInRight").addClass("loser");
        return $('.eatery-well').addClass("winner");
      }
    };
    delay = function(ms, func) {
      return setTimeout(func, ms);
    };
    return delay(1500, fightScore);
  });
...
(function() {
  $(function() {
    $("#price").change(function() {
      var newValue;
      newValue = $("#price").val();
      return $(".price-display").text(newValue);
    });
    $("#portion").change(function() {
      var newValue;
      newValue = $("#portion").val();
      return $(".portion-display").text(newValue);
    });
    $("#taste").change(function() {
      var newValue;
      newValue = $("#taste").val();
      return $(".taste-display").text(newValue);
    });
