...
ActiveRecord::Schema.define(version: 20140616012429) do
  ...
  add_index "categorizations", ["eatery_id"], name: "index_categorizations_on_eatery_id", using: :btree
  ...
  add_index "likes", ["eatery_id"], name: "index_likes_on_eatery_id", using: :btree
